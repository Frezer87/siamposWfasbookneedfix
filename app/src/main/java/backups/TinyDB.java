...
public class TinyDB {
    ...
    public ArrayList<ProviderShoppingCart> getListObject(String key, Class<?> mClass) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ProviderShoppingCart> objects = new ArrayList<ProviderShoppingCart>();

        for (String jObjString : objStrings) {
            Object value = gson.fromJson(jObjString, mClass);
            objects.add((ProviderShoppingCart) value);
        }
        return objects;
    }

    public ArrayList<ProviderMyOrders> getListObject2(String key, Class<?> mClass) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ProviderMyOrders> objects = new ArrayList<ProviderMyOrders>();

        for (String jObjString : objStrings) {
            Object value = gson.fromJson(jObjString, mClass);
            objects.add((ProviderMyOrders) value);
        }
        return objects;
    }

    public ArrayList<ProviderLetterMenu> getListObject3(String key, Class<?> mClass) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ProviderLetterMenu> objects = new ArrayList<ProviderLetterMenu>();

        for (String jObjString : objStrings) {
            Object value = gson.fromJson(jObjString, mClass);
            objects.add((ProviderLetterMenu) value);
        }
        return objects;
    }
    ...
    public void putListObject(String key, ArrayList<ProviderShoppingCart> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
    ...
    public void putListObject2(String key, ArrayList<ProviderMyOrders> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (Object obj : objArray) {
    ...
    public void putListObject3(String key, ArrayList<ProviderLetterMenu> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (Object obj : objArray) {
